...
use crate::models::ship::{CaptainLogEntry, DockingRequest, FighterCommand, HailMessage};
...
impl GameWorld {
    ...
    pub fn register_player(&mut self, name: String) -> Result<String, String> {
        ...
        {
            return Err(
                "Player name can only contain alphanumeric characters, underscores, and hyphens"
                    .to_string(),
            );
        }
    ...
    pub fn find_nearest_station(&self, position: [f64; 3]) -> Option<&Station> {
        self.stations.values().min_by(|a, b| {
    ...
    pub fn get_captain_log_entries(&self, ship_id: &str) -> Vec<CaptainLogEntry> {
        self.captain_logs.get(ship_id).cloned().unwrap_or_default()
    }
    ...
    pub fn remove_docking_requests(&mut self, ship_id: &str) {
        self.docking_requests
            .retain(|_, req| req.ship_id != ship_id);
    }
    ...
    pub fn add_countermeasure_load(
        &mut self,
        ship_id: String,
        cm_type: crate::api::positions::countermeasures::CountermeasureType,
        quantity: u32,
    ) {
        let type_str = match cm_type {
            crate::api::positions::countermeasures::CountermeasureType::Antimissile => {
                "antimissile"
            }
            crate::api::positions::countermeasures::CountermeasureType::Antitorpedo => {
                "antitorpedo"
            }
            crate::api::positions::countermeasures::CountermeasureType::Chaff => "chaff",
        };
        self.countermeasure_loads
            .push((ship_id, type_str.to_string(), quantity));
    }
    ...
    pub fn configure_kinetic_weapon(
        &mut self,
        _ship_id: String,
        _weapon_id: String,
        _kind: String,
    ...
    pub fn load_missile_ordnance(
        &mut self,
        _ship_id: String,
        _weapon_id: String,
        _ordnance_type: String,
        _quantity: u32,
    ) {
        // Placeholder - would integrate with simulation
    }
    ...
    pub fn add_power_allocations(
        &mut self,
        ship_id: String,
        allocations: std::collections::HashMap<String, f32>,
    ) {
        // Get the ship and update its module power allocations
        if let Some(_ship) = self.ships.get_mut(&ship_id) {
    ...
    pub fn add_cooling_allocations(
        &mut self,
        ship_id: String,
        allocations: std::collections::HashMap<String, f32>,
    ) {
    ...
    pub fn add_auxiliary_activation(
        &mut self,
        _ship_id: String,
        _module_id: String,
        _duration: f32,
...
mod tests {
    ...
    fn test_player_removal() {
        ...
        let player_id = world.register_player("Alice".to_string()).unwrap();
        let team_id = world
            .create_team("Alpha".to_string(), "Federation".to_string())
            .unwrap();
    ...
    fn test_blueprint_queries() {
        ...
        let team1_id = world
            ...
            .unwrap();
        let team2_id = world
            .create_team("Bravo".to_string(), "Empire".to_string())
            .unwrap();

        world
            .create_blueprint("Ship1".to_string(), "cruiser".to_string(), team1_id.clone())
            .unwrap();
        world
            .create_blueprint(
                "Ship2".to_string(),
            ...
            .unwrap();
        world
            .create_blueprint("Ship3".to_string(), "frigate".to_string(), team2_id.clone())
            .unwrap();
    ...
    fn test_game_stats() {
        ...
        let team_id = world
            ...
            .unwrap();
        world
            .create_blueprint("Ship1".to_string(), "cruiser".to_string(), team_id)
            .unwrap();
