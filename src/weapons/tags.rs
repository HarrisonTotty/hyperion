...
impl WeaponTagCalculator {
    ...
    pub fn validate_tags(&self, tags: &[WeaponTag]) -> Result<(), String> {
        ...
        if fire_pattern_count > 1 {
            return Err(
                "Weapon cannot have multiple fire pattern tags (Beam, Burst, Pulse, SingleFire)"
                    .to_string(),
            );
        }
    ...
    pub fn has_status_effect(&self, tags: &[WeaponTag]) -> bool {
        tags.iter()
            .any(|t| matches!(t, WeaponTag::Ion | WeaponTag::Graviton | WeaponTag::Tachyon))
    }
...
mod tests {
    ...
    fn test_beam_weapon() {
        ...
        let result = calculator
            .calculate_damage(100.0, &[WeaponTag::Beam])
            .unwrap();
    ...
    fn test_burst_weapon() {
        let calculator = WeaponTagCalculator::new();
        let result = calculator
            .calculate_damage(100.0, &[WeaponTag::Burst])
            .unwrap();
    ...
    fn test_pulse_weapon() {
        let calculator = WeaponTagCalculator::new();
        let result = calculator
            .calculate_damage(100.0, &[WeaponTag::Pulse])
            .unwrap();
    ...
    fn test_single_fire_weapon() {
        let calculator = WeaponTagCalculator::new();
        let result = calculator
            .calculate_damage(100.0, &[WeaponTag::SingleFire])
            .unwrap();
    ...
    fn test_photon_shield_damage() {
        let calculator = WeaponTagCalculator::new();
        let result = calculator
            .calculate_damage(100.0, &[WeaponTag::Photon])
            .unwrap();
    ...
    fn test_plasma_shield_damage() {
        let calculator = WeaponTagCalculator::new();
        let result = calculator
            .calculate_damage(100.0, &[WeaponTag::Plasma])
            .unwrap();
    ...
    fn test_positron_shield_bypass() {
        let calculator = WeaponTagCalculator::new();
        let result = calculator
            .calculate_damage(100.0, &[WeaponTag::Positron])
            .unwrap();
    ...
    fn test_ion_status_effect() {
        let calculator = WeaponTagCalculator::new();
        let result = calculator
            .calculate_damage(100.0, &[WeaponTag::Ion])
            .unwrap();
    ...
    fn test_graviton_status_effect() {
        let calculator = WeaponTagCalculator::new();
        let result = calculator
            .calculate_damage(100.0, &[WeaponTag::Graviton])
            .unwrap();
    ...
    fn test_tachyon_status_effect() {
        let calculator = WeaponTagCalculator::new();
        let result = calculator
            .calculate_damage(100.0, &[WeaponTag::Tachyon])
            .unwrap();
    ...
    fn test_combined_tags() {
        ...
        // Burst Photon weapon
        let result = calculator
            .calculate_damage(100.0, &[WeaponTag::Burst, WeaponTag::Photon])
            .unwrap();
    ...
    fn test_get_fire_pattern() {
        ...
        assert_eq!(
            calculator.get_fire_pattern(&[WeaponTag::Beam]),
            Some(WeaponTag::Beam)
        );
        assert_eq!(
            calculator.get_fire_pattern(&[WeaponTag::Burst, WeaponTag::Photon]),
            Some(WeaponTag::Burst)
        );
    ...
    fn test_antimissile_damage() {
        let calculator = WeaponTagCalculator::new();
        let result = calculator
            .calculate_damage(100.0, &[WeaponTag::Antimissile])
            .unwrap();
    ...
    fn test_antitorpedo_damage() {
        let calculator = WeaponTagCalculator::new();
        let result = calculator
            .calculate_damage(100.0, &[WeaponTag::Antitorpedo])
            .unwrap();
    ...
    fn test_decoy_no_damage() {
        let calculator = WeaponTagCalculator::new();
        let result = calculator
            .calculate_damage(100.0, &[WeaponTag::Decoy])
            .unwrap();
    ...
    fn test_chaff_no_damage() {
        let calculator = WeaponTagCalculator::new();
        let result = calculator
            .calculate_damage(100.0, &[WeaponTag::Chaff])
            .unwrap();
