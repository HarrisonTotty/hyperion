...
pub fn assert_params_in_ranges(p: &GalaxyParams, max_sigmas: f64) {
    ...
    // The fixture's one scatter is the Milky Way's measured offset from M–σ, 1.02 times the
    // relation's 0.38 dex at plan 08's σ_e of 117.7 km/s (P08.T4.d with ruling 105.1; 0.55 times
    // at plan 02's spherical 109.5 km/s, 1.35 times at P02.T11's 123.8 km/s), so this bound never
    // falls below 1.5 of it.
