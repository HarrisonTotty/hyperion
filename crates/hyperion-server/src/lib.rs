...
pub(crate) struct AppState {
    ...
    /// The range briefs' models built so far, in the configured byte budget: what a
    /// `systems_in_range` with `include_stellar` reads (plan 06, P06.T34).
    pub(crate) briefs: SharedBriefCache,
